...
//@input string voiceMLLanguage {"label": "Voice ML Language","widget":"combobox", "values":[{"label":"System Language", "value":"LANGUAGE_AUTOMATIC"},{"label":"English", "value":"LANGUAGE_ENGLISH"},{"label":"Spanish", "value":"LANGUAGE_SPANISH"},{"label":"German", "value":"LANGUAGE_GERMAN"}] }
//@ui {"widget":"separator"}
...
//@ui {"widget":"separator","showIf":"voiceMLLanguage", "showIfValue":"LANGUAGE_ENGLISH"}
//@input bool useCommand {"showIf":"voiceMLLanguage", "showIfValue":"LANGUAGE_ENGLISH"}
...
//@ui {"widget":"separator","showIf":"voiceMLLanguage", "showIfValue":"LANGUAGE_ENGLISH"}
//@input bool useSYSTEM_VOICE_COMMAND  {"showIf":"voiceMLLanguage", "showIfValue":"LANGUAGE_ENGLISH"}
...
function initializeKeywords() {
    ...
    for (var i = 0; i < parent.getChildrenCount(); i++) {
        ...
        if (child.enabled) {
            ...
            var data = {
                mkeyword: st.api.getKeyword!==null && st.api.getKeyword()["Keyword"],
...
function initialize() {
    ...
    voiceMLLanguage = languageOption.language;
